    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateTimeField(verbose_name='Start date and time (MM/DD/YYYY HH:MM:SS)')),
                ('end', models.DateTimeField(verbose_name='End date and time (MM/DD/YYYY HH:MM:SS)')),
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
                ('description', models.TextField(blank=True, max_length=2048, verbose_name='Description')),
                ('end_recurring_period', models.NullBooleanField(verbose_name='Appointment Covered by Insurance?')),
        ...
        migrations.AddField(
            model_name='event',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events', to='calendarium.EventCategory', verbose_name='Doctor'),
        ),
        migrations.AddField(
            model_name='event',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events', to=settings.AUTH_USER_MODEL, verbose_name='Patient'),
        ),
    ]
