...
class Patient(models.Model):
    ...
    @classmethod
    def create(cls, user, birthday_string, sex_verbose, b_type, height, weight, allergies, insurance, p_hos_string,
               emerg_con_email):
        try:
        ...
        return cls(user=user, birthday=birthday_string, sex=str(dict(Patient.SEX_CHOICE)[sex_verbose]),
                   blood_type=b_type, height=height, weight=weight, allergies=allergies, insurance_info=insurance,
                   preferred_hospital=Hospital.objects.get(name=p_hos_string),
                   hospital=Hospital.objects.get(name=p_hos_string), emergency_contact=emerg_con_email,
                   emergency_contact_user=emerg_con_user)
